...
class mydb extends Migration {
	...
	public function up()
	{
		...
		Schema::create('diseases', function($disease) {
			...
			$disease->string('disease_pic')->default('default.png');
		...
		Schema::create('doctors', function($doctor) {
			...
			$doctor->string('doctor_pic')->default('default.png');
		...
		Schema::create('drugs', function($drug) {
			...
			$drug->string('drug_pic')->default('default.png');
		...
		Schema::create('hospitals', function($hospital) {
			...
			$hospital->string('hospital_pic')->default('default.png');
		...
		Schema::create('news', function($news) {
			$news->increments('id'); 
			$news->string('news_author');
			$news->string('news_titel');
			$news->text('news_body');
			$news->timestamps();
		});
		...
		Schema::create('symptoms', function($symptom) {
			...
			$symptom->string('symtom_pic')->default('default.png');
			$symptom->text('symtom_details');
			$symptom->timestamps();
		});

		Schema::create('tips', function($tip) {
			$tip->increments('id'); 
			$tip->string('tip_author');
			$tip->string('tip_titel');
			$tip->text('tip_body');
			$tip->timestamps();
		});
		...
		Schema::create('users', function($user) {
			...
			$user->string('user_pic')->default('default.png');
